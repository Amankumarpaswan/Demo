...
export async function POST(request: NextRequest) {
  try {
    ...
    const apiKey = process.env.NEXT_PUBLIC_OPENROUTER_API_KEY || "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";
    ...
    if (!response.ok) {
      console.error('❌ API Error [Quote]:', await response.text());
